...
add_action( 'customize_register', 'glossy_blog_post_snippet_featured_image' );
function glossy_blog_post_snippet_featured_image( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_featured_image', array(
        'sanitize_callback'     =>  'glossy_blog_sanitize_checkbox',
        'default'               =>  glossy_blog_get_default_post_snippet_featured_image()
    ) );
...
add_action( 'customize_register', 'glossy_blog_post_snippet_featured_image_size' );
function glossy_blog_post_snippet_featured_image_size( $wp_customize ) {

    $wp_customize->add_setting( 'post_snippet_featured_image_size', array(
        'default'     => glossy_blog_get_default_post_snippet_featured_image_size(),
    ...
    $wp_customize->add_control( 'post_snippet_featured_image_size', array(
        ...
        'active_callback' => function(){
            return get_theme_mod( 'post_snippet_hide_show_featured_image', glossy_blog_get_default_post_snippet_featured_image() );
        },
        'choices'     => array(
