...
add_action( 'customize_register', 'glossy_blog_post_snippet_social_share' );
function glossy_blog_post_snippet_social_share( $wp_customize ) {

	$wp_customize->add_setting( 'post_snippet_hide_show_social_share', array(
        'sanitize_callback'     =>  'glossy_blog_sanitize_checkbox',
        'default'               =>  glossy_blog_get_default_post_snippet_social_share()
    ) );
...
add_action( 'customize_register', 'glossy_blog_post_snippet_social_share_options' );
function glossy_blog_post_snippet_social_share_options( $wp_customize ) {

    $wp_customize->add_setting( 'post_snippet_social_share_options', array(
        'sanitize_callback' => 'glossy_blog_sanitize_array',
        'default'     => glossy_blog_get_default_post_snippet_social_share_options()
    ) );
    ...
    $wp_customize->add_control( new Graphthemes_Multi_Check_Control( $wp_customize, 'post_snippet_social_share_options', array(
        ...
        'active_callback' => function() {
            return get_theme_mod( 'post_snippet_hide_show_social_share', glossy_blog_get_default_post_snippet_social_share() );
        }
    ) ) );
